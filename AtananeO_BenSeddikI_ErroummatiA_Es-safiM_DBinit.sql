...
constraint CustomerAccountsCstr foreign key(cust_id) references BankCustomer(cust_id) on update cascade on delete set null,
constraint AccIdCustomerCstr foreign key(acc_id) references Account(account_id) on update cascade on delete set null);
...
--bank_employee
INSERT INTO bank_employee (employee_id, employee_fname, employee_lname, employee_adress, employee_gender, employee_email, manager_id) VALUES 
(300,'Xander','Ruiz','418-8548 Tempor, Road','M','enim.sit@elitelit.net',NULL),
(302,'Kevin','Dodson','Ap #274-163 Egestas St.','M','sodales.elit.erat@nisisemsemper.net',300),
(304,'Summer','Hull','779-4427 Vulputate, St.','F','egestas.Fusce.aliquet@euismod.com',300),
(306,'Hector','Lancaster','2777 Ridiculus St.','M','orci.Donec.nibh@bibendum.com',304),
(308,'Marsden','Valenz','Ap #121-7435 Quisque Road','M','ac.turpis.egestas@Morbiquisurna.org',NULL),
(310,'Calvin','Leon','Ap #897-9073 Adipiscing St.','M','ac.turpis.egestas@fringillacursuspurus.net',304),
(312,'Wayne','Schneider','400-4579 Suspendisse Ave','M','tempor.erat@Praesent.co.uk',300),
(314,'Regan','Slater','Ap #512-8810 Curabitur Avenue','M','iaculis.odio@risusDonec.com',308),
(316,'Chris','Hopkins','Ap #897-7672 Sagittis Av.','M','risus@feugiatLoremipsum.edu',308),
(318,'Cara','Poole','2193 Ac Avenue','F','ante.ipsum.primis@lacusvestibulumlorem.net',304),
(320,'Amethyst','Lynch','P.O. Box 863, 9007 Eget, Ave','F','Aliquam.ornare.libero@luctuslobortis.org',300);
...
--Procedure1: Procedure for a customer to withdraw an amount from
...
--Function 1: Function to obtain all the employees that directly
or indirectly to a particular manager:
...
--Query1: Get the customers having a current account with a balance 
of more than $1000:
